...
function PanelTheStruggle() {
  ...
  return (
    ...
    >
      {/* Illustration area */}
      <div className="relative bg-gradient-to-br from-[#f0f2f5] to-[#e8eaed] flex items-center justify-center min-h-[240px] md:min-h-[280px]">
        <Image
          src="/without_sayso_part_1.png"
